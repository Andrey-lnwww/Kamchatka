(() => {
    ...
    (() => {
        ...
        const pickerPopup = datepicker_min("[data-datepickerPopup]", {
            customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс" ],
            customMonths: [ "Янв", "Фев", "Мар", "Апр", "Май", "Июн", "Июл", "Авг", "Сен", "Окт", "Ноя", "Дек" ],
            overlayButton: "Применить",
            overlayPlaceholder: "Год (4 цифры)",
        ...
        flsModules.datepicker = pickerPopup;
        ...
        function initSliders() {
            if (document.querySelector(".dreams__slider")) {
                new core(".dreams__slider", {
                    modules: [ Navigation ],
                    grabCursor: true,
                    observer: true,
                    observeParents: true,
            ...
            if (document.querySelector(".day1__slider")) {
                let day1Slider = new core(".day1__slider", {
                    modules: [ Navigation ],
                    grabCursor: true,
                    observer: true,
                    observeParents: true,
                    ...
                    resizeObserver: true,
                    navigation: {
                        prevEl: ".day1__button-prev",
                        nextEl: ".day1__button-next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 19
            ...
            if (document.querySelector(".day2__slider")) {
                new core(".day2__slider", {
                    modules: [ Navigation ],
                    grabCursor: true,
                    observer: true,
                    observeParents: true,
                    ...
                    resizeObserver: true,
                    navigation: {
                        prevEl: ".day2__button-prev",
                        nextEl: ".day2__button-next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 19
            ...
            if (document.querySelector(".day3__slider")) {
                new core(".day3__slider", {
                    modules: [ Navigation ],
                    grabCursor: true,
                    observer: true,
                    observeParents: true,
                    ...
                    resizeObserver: true,
                    navigation: {
                        prevEl: ".day3__button-prev",
                        nextEl: ".day3__button-next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 19
            ...
            if (document.querySelector(".day4__slider")) {
                new core(".day4__slider", {
                    modules: [ Navigation ],
                    grabCursor: true,
                    observer: true,
                    observeParents: true,
                    ...
                    resizeObserver: true,
                    navigation: {
                        prevEl: ".day4__button-prev",
                        nextEl: ".day4__button-next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 19
            ...
            if (document.querySelector(".day5__slider")) {
                new core(".day5__slider", {
                    modules: [ Navigation ],
                    grabCursor: true,
                    observer: true,
                    observeParents: true,
                    ...
                    resizeObserver: true,
                    navigation: {
                        prevEl: ".day5__button-prev",
                        nextEl: ".day5__button-next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 19
            ...
            if (document.querySelector(".day6__slider")) {
                new core(".day6__slider", {
                    modules: [ Navigation ],
                    grabCursor: true,
                    observer: true,
                    observeParents: true,
                    ...
                    resizeObserver: true,
                    navigation: {
                        prevEl: ".day6__button-prev",
                        nextEl: ".day6__button-next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 19
            ...
            if (document.querySelector(".day7__slider")) {
                new core(".day7__slider", {
                    modules: [ Navigation ],
                    grabCursor: true,
                    observer: true,
                    observeParents: true,
                    ...
                    resizeObserver: true,
                    navigation: {
                        prevEl: ".day7__button-prev",
                        nextEl: ".day7__button-next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 19
        ...
        if (counters) counters.forEach((counter => {
            counter.addEventListener("click", (e => {
                const target = e.target;
                if (target.closest(".form-counter__button")) {
                    if ("" == target.closest(".form-info__content").querySelector("input").value && (target.classList.contains("form-counter__minus") || target.classList.contains("form-counter__plus"))) target.closest(".form-info__content").querySelector("input").value = 0;
                    let value = parseInt(target.closest(".form-info__content").querySelector("input").value);
                    if (target.classList.contains("form-counter__plus")) {
                        if (value < 999) value++;
                    } else --value;
                    if (value <= 0) {
                        value = 0;
                        target.closest(".form-counter").querySelector(".form-counter__minus").classList.add("form-counter--disabled");
                    } else target.closest(".form-counter").querySelector(".form-counter__minus").classList.remove("form-counter--disabled");
                    if (value >= 999) target.closest(".form-counter").querySelector(".form-counter__plus").classList.add("form-counter--disabled"); else target.closest(".form-counter").querySelector(".form-counter__plus").classList.remove("form-counter--disabled");
                    target.closest(".form-info__content").querySelector("input").value = value;
                }
            }));
        }));
        const numberInputs = document.querySelectorAll(".form-info__counter");
        numberInputs.forEach((numberInputs => {
            numberInputs.addEventListener("input", (() => {
                const value = Number(numberInputs.value);
                const max = Number(numberInputs.max);
                const min = Number(numberInputs.min);
                if (value > max) numberInputs.value = max; else if (value < min) numberInputs.value = min;
            }));
        }));
        document.addEventListener("watcherCallback", (function(e) {
            const entry = e.detail.entry;
            const targetElement = entry.target;
            if (targetElement.classList.contains("kamchatka")) {
                const airplane = document.querySelector(".kamchatka__airplane");
                const content = document.querySelector(".kamchatka__text");
                if (targetElement.classList.contains("_watcher-view")) {
                    airplane.classList.add("kamchatka__airplane--active");
                    targetElement.classList.add("kamchatka--active");
                    content.classList.add("fadeInUp");
                } else {
                    airplane.classList.remove("kamchatka__airplane--active");
                    targetElement.classList.remove("kamchatka--active");
                }
            }
        }));
        if (document.documentElement.clientWidth >= 1440) {
            const dayMarks = document.querySelectorAll(".day__title");
            dayMarks.forEach((element => {
                document.addEventListener("watcherCallback", (function(e) {
                    const entry = e.detail.entry;
                    const targetElement = entry.target;
                    if (targetElement.classList.contains("_watcher-view") && targetElement.classList.contains("day__title")) targetElement.classList.add("day__title--active"); else targetElement.classList.remove("day__title--active");
                }));
            }));
        }
        document.addEventListener("watcherCallback", (function(e) {
            const entry = e.detail.entry;
            const targetElement = entry.target;
            if (targetElement.classList.contains("program") && targetElement.classList.contains("_watcher-view")) targetElement.classList.add("fadeInUp");
            const benefits = document.querySelector(".benefits");
            if (benefits.classList.contains("_watcher-view")) {
        ...
        document.addEventListener("watcherCallback", (function(e) {
            const entry = e.detail.entry;
            const targetElement = entry.target;
            if (targetElement.classList.contains("dreams") && targetElement.classList.contains("_watcher-view")) {
                const mainContent = document.querySelectorAll(".dreams__column");
                mainContent.forEach((e => {
                    e.classList.add("fadeInUpMain");
                }));
                const socialMain = document.querySelector(".social");
                socialMain.classList.add("bounceInDownMainSocial");
            }
        }));
        document.addEventListener("watcherCallback", (function(e) {
            const entry = e.detail.entry;
            ...
            if (targetElement.classList.contains("day3") && targetElement.classList.contains("_watcher-view")) {
                ...
                day3.classList.add("fadeInUpMain");
            }
            if (targetElement.classList.contains("day4") && targetElement.classList.contains("_watcher-view")) {
                const day4 = document.querySelector(".day4__content");
                day4.classList.add("fadeInUpMain");
            }
            if (targetElement.classList.contains("day5") && targetElement.classList.contains("_watcher-view")) {
                const day5 = document.querySelector(".day5__content");
                day5.classList.add("fadeInUpMain");
            }
            if (targetElement.classList.contains("day6") && targetElement.classList.contains("_watcher-view")) {
                const day6 = document.querySelector(".day6__content");
                day6.classList.add("fadeInUpMain");
            }
            if (targetElement.classList.contains("day7") && targetElement.classList.contains("_watcher-view")) {
                const day7 = document.querySelector(".day7__content");
                day7.classList.add("fadeInUpMain");
            }
            if (targetElement.classList.contains("day8") && targetElement.classList.contains("_watcher-view")) {
                const day8 = document.querySelector(".day8__text");
                day8.classList.add("fadeInUpMain");
            }
        }));
        window["FLS"] = true;
        isWebp();
